...
public static class Qt
{
    ...
    [
        ...
        ("神秘纹", "Crest", new HotKeyResolver(SpellsDef.ArcaneCrest,
                                                                  SpellTargetType.Self,
                                                   ForceNextSlots)),
        ("LB", "LB", new HotKeyResolver_LB()),
        ("亲疏", "Armslength", new HotKeyResolver(SpellsDef.ArmsLength,
                                                                     SpellTargetType.Self,
                                                      ForceNextSlots)),
        ("内丹", "SecondWind", new HotKeyResolver(SpellsDef.SecondWind,
                                                                     SpellTargetType.Self,
                                                      ForceNextSlots)),
        ("浴血", "BloodBath", new HotKeyResolver(SpellsDef.Bloodbath,
                                                                     SpellTargetType.Self,
                                                      ForceNextSlots)),
        ("牵制", "Feint", new HotKeyResolver(SpellsDef.Feint,
                                                                useHighPrioritySlot: ForceNextSlots)),
        ("真北", "TrueNorth", new HotKeyResolver(SpellsDef.TrueNorth,
                                                                    SpellTargetType.Self,
                                                     ForceNextSlots)),
